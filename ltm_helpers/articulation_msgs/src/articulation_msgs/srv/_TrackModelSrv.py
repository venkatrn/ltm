"""autogenerated by genpy from articulation_msgs/TrackModelSrvRequest.msg. Do not edit."""
import sys
...
class TrackModelSrvRequest(genpy.Message):
  _md5sum = "492b025b4d335f83e3fab65eb3211a27"
  _type = "articulation_msgs/TrackModelSrvRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackModelSrvRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from articulation_msgs/TrackModelSrvResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TrackModelSrvResponse(genpy.Message):
  _md5sum = "492b025b4d335f83e3fab65eb3211a27"
  _type = "articulation_msgs/TrackModelSrvResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackModelSrvResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.model is None:
        self.model = articulation_msgs.msg.ModelMsg()
    else:
...
_struct_2I = struct.Struct("<2I")
_struct_3d = struct.Struct("<3d")
class TrackModelSrv(object):
  _type          = 'articulation_msgs/TrackModelSrv'
  _md5sum = 'c9416af83362c7c0e98c9f877c3e7b6b'
  _request_class  = TrackModelSrvRequest
  _response_class = TrackModelSrvResponse
