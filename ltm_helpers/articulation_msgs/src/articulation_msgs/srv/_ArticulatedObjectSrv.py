"""autogenerated by genpy from articulation_msgs/ArticulatedObjectSrvRequest.msg. Do not edit."""
import sys
...
class ArticulatedObjectSrvRequest(genpy.Message):
  _md5sum = "5d5d9e6b857e5dae46feed46b9a03103"
  _type = "articulation_msgs/ArticulatedObjectSrvRequest"
...
================================================================================
MSG: articulation_msgs/ArticulatedObjectMsg
...
"""
  __slots__ = ['object']
  _slot_types = ['articulation_msgs/ArticulatedObjectMsg']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArticulatedObjectSrvRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.object is None:
        self.object = articulation_msgs.msg.ArticulatedObjectMsg()
    else:
      self.object = articulation_msgs.msg.ArticulatedObjectMsg()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.object.parts)
      buff.write(_struct_I.pack(length))
      for val1 in self.object.parts:
        _v1 = val1.header
      ...
      length = len(self.object.params)
      buff.write(_struct_I.pack(length))
      for val1 in self.object.params:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.object.models)
      buff.write(_struct_I.pack(length))
      for val1 in self.object.models:
        _v10 = val1.header
      ...
      length = len(self.object.markers.markers)
      buff.write(_struct_I.pack(length))
      for val1 in self.object.markers.markers:
        _v22 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.object.params.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.object.models = []
      for i in range(0, length):
        ...
        self.object.models.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.object.markers.markers = []
      for i in range(0, length):
        ...
        self.object.markers.markers.append(val1)
      return self
...
"""autogenerated by genpy from articulation_msgs/ArticulatedObjectSrvResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ArticulatedObjectSrvResponse(genpy.Message):
  _md5sum = "5d5d9e6b857e5dae46feed46b9a03103"
  _type = "articulation_msgs/ArticulatedObjectSrvResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """articulation_msgs/ArticulatedObjectMsg object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArticulatedObjectSrvResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.object is None:
        self.object = articulation_msgs.msg.ArticulatedObjectMsg()
    else:
    ...
    try:
      ...
      for val1 in self.object.models:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_i.pack(_v128.id))
        length = len(_v128.pose)
        buff.write(_struct_I.pack(length))
        for val3 in _v128.pose:
          _v131 = val3.position
          _x = _v131
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
          ...
          _x = _v132
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v128.pose_headers)
        buff.write(_struct_I.pack(length))
        for val3 in _v128.pose_headers:
          buff.write(_struct_I.pack(val3.seq))
          _v133 = val3.stamp
          _x = _v133
          buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
        length = len(_v128.pose_projected)
        buff.write(_struct_I.pack(length))
        for val3 in _v128.pose_projected:
          _v134 = val3.position
          _x = _v134
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
          ...
          _x = _v135
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v128.pose_resampled)
        buff.write(_struct_I.pack(length))
        for val3 in _v128.pose_resampled:
          _v136 = val3.position
          _x = _v136
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
          ...
          _x = _v137
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v128.pose_flags)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.pack(pattern, *_v128.pose_flags))
        length = len(_v128.channels)
        buff.write(_struct_I.pack(length))
        for val3 in _v128.channels:
          _x = val3.name
          length = len(_x)
          if python3 or type(_x) == unicode:
            _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v157.id,) = _struct_i.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v157.pose = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3.frame_id = str[start:end]
          _v157.pose_headers.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v157.pose_projected = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v163 = val3.position
          _x = _v163
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
          _v157.pose_projected.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v157.pose_resampled = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v165 = val3.position
          _x = _v165
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
          _v157.pose_resampled.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sI'%length
        ...
        _v157.pose_flags = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v157.channels = []
    ...
    try:
      ...
      for val1 in self.object.models:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_i.pack(_v186.id))
        length = len(_v186.pose)
        buff.write(_struct_I.pack(length))
        for val3 in _v186.pose:
          _v189 = val3.position
          _x = _v189
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
          ...
          _x = _v190
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v186.pose_headers)
        buff.write(_struct_I.pack(length))
        for val3 in _v186.pose_headers:
          buff.write(_struct_I.pack(val3.seq))
          _v191 = val3.stamp
          _x = _v191
          buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
        length = len(_v186.pose_projected)
        buff.write(_struct_I.pack(length))
        for val3 in _v186.pose_projected:
          _v192 = val3.position
          _x = _v192
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
          ...
          _x = _v193
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v186.pose_resampled)
        buff.write(_struct_I.pack(length))
        for val3 in _v186.pose_resampled:
          _v194 = val3.position
          _x = _v194
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
          ...
          _x = _v195
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v186.pose_flags)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(_v186.pose_flags.tostring())
        length = len(_v186.channels)
        buff.write(_struct_I.pack(length))
        for val3 in _v186.channels:
          _x = val3.name
          length = len(_x)
          if python3 or type(_x) == unicode:
            _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v215.id,) = _struct_i.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v215.pose = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3.frame_id = str[start:end]
          _v215.pose_headers.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v215.pose_projected = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v221 = val3.position
          _x = _v221
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
          _v215.pose_projected.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v215.pose_resampled = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v223 = val3.position
          _x = _v223
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
          _v215.pose_resampled.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sI'%length
        ...
        _v215.pose_flags = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v215.channels = []
...
_struct_2I = struct.Struct("<2I")
_struct_3d = struct.Struct("<3d")
class ArticulatedObjectSrv(object):
  _type          = 'articulation_msgs/ArticulatedObjectSrv'
  _md5sum = '15c3db27c762fecdf8ce2ef6fbe54b87'
  _request_class  = ArticulatedObjectSrvRequest
  _response_class = ArticulatedObjectSrvResponse
